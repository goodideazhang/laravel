...
<head>
    ...
    <link rel="stylesheet" href="//res.layui.com/layui/dist/css/layui.css?t=1525771196163" media="all">
    <style>
        body{margin: 10px;}
...
<blockquote class="layui-elem-quote layui-quote-nm" id="footer"> 提供强力驱动</blockquote>


<script src="//res.layui.com/layui/dist/layui.js?t=1525771196163"></script>
<script>
    layui.config({
